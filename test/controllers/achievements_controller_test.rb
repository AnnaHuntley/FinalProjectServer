...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference("Achievement.count") do
      post achievements_url, params: { achievement: { description: @achievement.description, title: @achievement.title, user_id: @achievement.user_id } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { description: @achievement.description, title: @achievement.title, user_id: @achievement.user_id } }

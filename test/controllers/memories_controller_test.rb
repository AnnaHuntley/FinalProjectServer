...
class MemoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memory" do
    assert_difference("Memory.count") do
      post memories_url, params: { memory: { date: @memory.date, description: @memory.description, location: @memory.location, title: @memory.title, user_id: @memory.user_id } }
    end
  ...
  test "should update memory" do
    patch memory_url(@memory), params: { memory: { date: @memory.date, description: @memory.description, location: @memory.location, title: @memory.title, user_id: @memory.user_id } }
